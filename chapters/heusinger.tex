...
\exi{}
\gll	Ye šomāreh-i  ro 	entexāb   kon        va  injā		alāmat 	bezan.			\hspace*{0.4cm}{\emph{ye(k) NP-i}} \\
	ye number-i   rā 	choose    do.{\sc{2sg}}  and here  	mark    	do.{\sc{2sg}}	\hspace*{0.4cm}{(free choice)} \\
\glt	`Choose a number and mark it here.'

\ex\label{4ex:4}
\gll	Yek bače-i		tu xiābun	gom	šode				bud.			\hspace*{1.5cm}{\emph{ye(k) NP-i}} \\
	ye     child-i   	at street	lost	became.{\sc{3sg}} 	was.{\sc{3sg}}	\hspace*{1.5cm}{(ref. ignorance)} \\
...
\ex\label{4ex:9}
	...
	\gll	Wówapi	waƞ			o$\langle$Ø-wá$\rangle$le.			\hspace*{1cm}[olé `look for'] \\
		book		a[+specific]	look.for$\langle${\sc{inan-1sg.a}}$\rangle$ \\
...
{{
\begin{tabularx}{\textwidth}{>{\raggedright}p{4cm}l>{\raggedright}Qp{1.8cm}}
\lsptoprule
...
\addplot[draw=black,fill=lsMidDarkBlue] table[x index=0,y index=1] \dataset;
\addplot[draw=black,fill=lsMidOrange] table[x index=0,y index=2] \dataset;
