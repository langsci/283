...
%the following additions: {\sc{a}} = set A case-role marker (Actor or Possessor),  {\sc{anim}} = animate, {\sc{b}} = set B case-role marker (Undergoer), {\sc{d}} = deictic, {\sc{disc}} = discourse particle, {\sc{emph}} = emphatic pronoun, {\sc{ev}} = prosodic echo vowel, {\sc{gm}} = gender marker, {\sc{hsy}} = hearsay particle, {\sc{inan}} = inanimate, {\sc{inch}} = inchoative, {\sc{int}} = intensifier, {\sc{nv}} = non visible, {\sc{poss}} = Possessive, {\sc{prep}} = general preposition, {\sc{scope}} = scope clitic, {\sc{t}} = transitivizer, {\sc{v}} = visible} \\
	[Author's data, {\emph{Ix Che'il etel B\"ak'}} `Wild Woman', J.\,S.]
	\exi{}
	\gll	inchech=e 		tan-{\O}				inw				il-ik-{\bf{ech}}. \\
		2.{\sc{emph=ev}}	be\_continuing-{\sc{3b}}	1{\sc{a}}(prevocalic)	see-{\sc{tr.ipfv-{\bf{2b}}}} \\
	\glt
	\exi{}
	\gll	winik-{\bf{ech}}. \\
		man-{\bf{{\sc{2b}}}} \\
	...
	\gll ``...''	kut'an		{\bf{a}}	{\bf{winik}}		t-uy						\"atan=a. \\
		{}	3.{\sc{quot}}	{\sc{art}}		man			{\sc{prep}}-3{\sc{a}}(prevocalic)	wife={\sc{ev}} \\
	\glt ` ``...'' said {\bf{the [{\sc{art}}] man}} to his wife.'
	\end{xlista}
\end{exe}
...
\gll 	jok'-ij				{\bf{a}}	{\bf{nooch=o}}.	Tal-ij					a		{\bf{nene'=e}}. \\
	exit-{\sc{3b.intr.pfv}}	{\sc{art}}	big={\sc{ev}}	come-{\sc{3b.intr.pfv}}	{\sc{art}}	small={\sc{ev}} \\
\glt	`{{\bf{The [{\sc{art}}] big (one)}} left off (lit. went out).  {\bf{The/a [{\sc{art}}] little (one)}} came.}'
\end{exe}
...
\gll	``...''	kut'an		b'in		{\bf{a}}	{\bf{b'in-ij}} 			{\bf{yalan}}	{\bf{kamaj=a}}.\\
	{}	3.{\sc{quot}}	{\sc{hsy}}	{\sc{art}}	go.{\sc{pfv-3b.intr.pfv}} 	under		bed={\sc{ev}}\\
\glt	` ``...'' said {\bf{the [{\sc{art}}] (one who) had gone under the bed}}.'
\end{exe}
...
\gll	pero 		{\bf{a}} 	{\bf{winik}} 	{\bf{a}} 	{\bf{b'e=e}}, 				u 		ka'		k\"ax-t-aj-\O  \\
	{\sc{disc}}	{\sc{art}}	man			{\sc{art}}	{\sc{d}}.3.{\sc{nv=ev}}	3{\sc{a}}	again	seek-{\sc{t-tr.pfv-3b}} \\
\glt
\exi{}
\gll	u 		laak' 		uy				\"atan. \\
	3{\sc{a}}	other		3{\sc{a}}(prevocalic)	wife \\
\glt	`So {\bf{that [{\sc{art}}] man, known by other than visual means}}, he looked again for another wife.'
\end{exe}
\end{samepage}
...
\gll	sas-aj-ij 					samal-il=i, \\
	lighten-{\sc{inch-3b.intr.pfv}}	next.day-{\sc{poss=ev}} \\
\glt
\exi{}
\gll	ka' 		b'in-oo'			tukadye' 		u 		k\"ax-t-aj-{\bf{\O}}-oo' 		b'in.	\\
	again	go.{\sc{pfv-3.pl}}	another.time	{\sc{3a}}	seek-{\sc{t-tr.pfv-3b-3.pl}}	{\sc{hsy}} \\
...
\exi{}
\gll	{\bf{le'ek}} 	{\bf{a}} 	{\bf{tz'unu'un}}	 in 		tz'on-aj-\O=a, \\
	{\sc{3.emph}}	{\sc{art}}	hummingbird	1{\sc{a}}	shoot-{\sc{tr.pfv-3b=ev}} \\
\glt
\exi{}
\gll	{\bf{le'ek}} 	a 	santo	k'in=i.  \\
	3.{\sc{emph}}	{\sc{art}}	holy		sun={\sc{ev}} \\
...
\exi{}
\gll	{\bf{jun}} 	{\bf{tuul}} 			b'in 		{\bf{a}} 	{\bf{winik=i}}, \\
	one		{\sc{clf.anim}}	{\sc{hsy}}		{\sc{art}}	man{\sc{=ev}} \\
\glt
\exi{}
\gll	top	ki'-{\O}			b'in		t-u			wich	a		jook'=o. \\
	very	be.good-3{\sc{b}}	{\sc{hsy}}	{\sc{prep-3a}}	eye	{\sc{art}}	fishing{\sc{=ev}} \\
...
\gll	o,	inen=e			waye'		watak-en \\
	oh	1.{\sc{emph=ev}}	{\sc{d.loc}}.1	be.imminent-1{\sc{b}} \\
\glt
\exi{}
\gll	waye'		yan-Ø		in		kaal,			kut'an		{\bf{winik=i}}. \\
	{\sc{d.loc.1}}	exist-3{\sc{b}}	{\sc{1a}}	hometown		3.{\sc{quot}}	man{\sc{=ev}} \\
\glt 
...
\gll 	ma' 		yan-{\O}	 	a 	b'\"ak=a. \\
	{\sc{neg}}	exist-{\sc{3b}}	{\sc{art}}	game{\sc{=ev}} \\
...
\exi{}
\gll	``...'' 	kut'an		{\bf{a}}	{\bf{winik}}		t-uy					\"atan=a. \\
	{}	3.{\sc{quot}}	{\sc{art}}	man			{\sc{prep-3a}}(prevocalic)	wife{\sc{=ev}} \\
\glt	` ``...'' said {\bf{the [{\sc{art}}] man}} to his wife.'
\end{exe}

We will show, however, that ART does not explicitly encode anaphoric definiteness,\is{definiteness!anaphoric} since it can also be found in nonanaphoric and non-definite contexts (see Sections \ref{3sec:32}-\ref{3sec:35} below). 
...
\exi{}
\gll	pero 		{\bf{a}} 	{\bf{winik}}		{\bf{a}} 	{\bf{b'e=e}}, 			u 		ka'		k\"ax-t-aj-\O \\
	{\sc{disc}}	ART	man	ART	{\sc{d.3.nv=ev}}		{\sc{3a}}	again	seek-{\sc{t-tr.pfv-3b}} \\
\glt
\exi{}
\gll	u 		laak' 		uy					\"atan. \\
	3{\sc{a}}	other		3{\sc{a}}(prevocalic)		wife \\
\glt	`So {\bf{that [{\sc{art}}] man, known through non-visual means}}, he looked again for another wife.'
\end{exe}
\end{samepage}
...
\gll	top 		kich'pan-{\O} 			ti			in 		wich, \\
	very		be.beautiful-3{\sc{b}}		{\sc{prep}}		1{\sc{a}}	eye \\
\glt
\exi{}
\gll	kut'an		b'in	 	{\bf{a}} 	{\bf{b'e'=e}}. \\
	3.{\sc{quot}}	{\sc{hsy}}	{\sc{art}}	{\sc{d}}.3.{\sc{nv=ev}} \\
...
\gll	ma'			patal-{\O}		u		ch'uy-t-e'			{\bf{a}}	{\bf{b'\"ak'=\"a}} \\
	{\sc{neg}}	be.able-{\sc{3b}}	{\sc{3a}}	hang-{\sc{t-tr.irr.3b}}	{\sc{art}}	meat{\sc{=ev}} \\
\glt
\exi{} 
\gll	{\bf{a}}	{\bf{winik}}		{\bf{a}}	{\bf{b'e'}}. \\
	{\sc{art}}	man			{\sc{art}}	{\sc{d.3.nv}} \\
\glt	`{\bf{That [{\sc{art}}] man, known through non-visual means}}, couldn't hoist up {\bf{the [{\sc{art}}] meat}}.'
\end{exe}
...
\glt
\exi{}
\gll	{\bf{le'ek}}	 	a 	walak-{\O}	 		u 		jan-t-ik-{\O}			in 		kabayoj=o. \\
	3.{\sc{emph}}	{\sc{art}}	be.habitual-{\sc{3b}} 	3{\sc{a}}	eat-{\sc{t-tr.ipfv-3b}}	1{\sc{a}}	horse{\sc{=EV}} \\
...
[\cite{ventur:76} 3:15, {\emph{Siete Kolor}} `Seven Colors', E.\,S.]
\exi{}
\gll	{\bf{le'ek}} 	{\bf{a}} 	{\bf{b'e'}}		u 		p'o'-aj-\O=a. \\
	3.{\sc{emph}}	{\sc{art}}	{\sc{d.3.nv}}	3{\sc{a}}	do.laundry-{\sc{tr.pfv-3b=ev}} \\
...
\gll	tz'a'-b'-ij	 				u 		meyaj	 \\
	give-{\sc{pass-3b.intr.pfv}}		{\sc{3a}}	work	\\
\glt
\exi{}
\gll	ichil 		jum	p'eel 		jardin. ... \\
	inside	one	{\sc{clf.inan}}	garden \\
\glt
\exi{}
\gll	bueno. 	{\bf{le'ek}} 	{\bf{a}} 	{\bf{meyaj}} 	{\bf{a}}	{\bf{b'e'}} 		u 		b'et-aj-\O=a  \\
	well		{\sc{3.emph}}	{\sc{art}}	work			{\sc{art}}	{\sc{d.3.nv}}	{\sc{3a}}	do-{\sc{tr.pfv-3b=ev}} \\
\glt	`He was given work in a garden. ... well, that work is what he did.'\newline 
[Lit. Well, {\bf{it is that which is work which is known through non-visual means}} (that) he did]
\end{exe}
...
\exi{}
\gll	o,    	inen=e 			waye’           	watak-en \\
	oh     {\sc{1.emph=ev}}	{\sc{d.loc.1}}	be.imminent-{\sc{1b}} \\
\glt
\exi{}
\gll	waye'           	yan-{\O}          	in     		kaal,			kut'an		{\bf{winik=i}}. \\
	{\sc{d.loc.1}}	exist-{\sc{3b}}	{\sc{1a}}	hometown		{\sc{3.quot}}	man={\sc{ev}} \\
...
\exi{}
\gll	{\bf{a}}	{\bf{uj=u}}			tan-{\O}				ilik 		u   		b'eel  \\
	{\sc{art}}	moon={\sc{ev}}		be.continuing-{\sc{3b}}	{\sc{int}}	{\sc{3a}}	go{\sc{.ipfv}} \\
\glt
\exi{}
\gll	jab'ix	ti 			tan-{\O}					u		b'eel 		{\bf{a}}	{\bf{k'in}}. 	 \\
	like	{\sc{prep}}		be.continuing-{\sc{3b}}		{\sc{3a}}	go.{\sc{ipfv}}	{\sc{art}}	sun \\
\glt	`{\bf{The [{\sc{art}}] moon}} goes along just like {\bf{the [{\sc{art}}] sun}} goes.'
\end{exe}
...
\gll	ok-ij 						b'in 			ichil 		{\bf{a}} 	{\bf{ka'an}} 	{\bf{a}} 	{\bf{b'e'=e}}. \\
	enter-{\sc{3b.intr.ipfv}}		{\sc{hsy}}		inside	{\sc{art}}	sky			{\sc{art}}	{\sc{d.3.nv=ev}} \\
...
\gll	bueno, 	{\bf{le'ek}} 	{\bf{a}}	{\bf{jesus=u}},  \\
	well		{\sc{3.emph}}	{\sc{art}}	Jesus={\sc{ev}} \\
\glt	
\exi{}
\gll	ti 			kaj-ij 					alka'-b'-\"al \\
	{\sc{prep}}		begin-{\sc{3b.intr.ipfv}}	run-{\sc{pass-intr.ipfv}} \\
...
\gll	u		tz'-aj-{\O}			b'in 			ich 	{\bf{k'aak'}}. \\
	{\sc{3a}}	put-{\sc{tr.pfv-3b}}	{\sc{hsy}}		in	fire \\
...
Although new referents that will remain topical are typically introduced with the {\emph{jun}} + classifier construction\is{classifiers!numeral classifiers} (Section \ref{3sec:334}), it is also possible for such a referent to be marked only with ART.  This is illustrated in (\ref{3ex:21}).
...
\gll	pues	a 	winik	a 	b’e=e 			u 		chaan-t-aj-\O  \\
	so	{\sc{art}}	man	{\sc{art}}	{\sc{d.3.nv=ev}}		{\sc{3a}}	gaze-{\sc{t-tr.pfv-3b}} \\
\glt
\exi{}
\gll	t-u  			tzeel=e 		uy(prevocalic) 	il-aj-\O=a  yan-{\O} 		{\bf{a}} 	{\bf{b'ak=a}}.\\
	{\sc{prep-3a}}	side={\sc{ev}} 	{\sc{3a}} 		see-{\sc{tr.pfv-3b=ev}}  exist-{\sc{3b}} 	{\sc{art}}		bone={\sc{ev}} \\
\glt	`So the mentioned man looked next to him, he saw there were {\bf{[{\sc{art}}] bone[s]}}.'
\end{exe}
...
\gll	jum	p'eel 		k'in 	b'in, \\
	one	{\sc{clf.inan}}	day	{\sc{hsy}}	\\
\glt
\exi{}
\gll	{\bf{le'ek}} 	{\bf{a}} 	{\bf{b'aalum}} 	uy				et'ok \\
	3.{\sc{emph}}	{\sc{art}}		jaguar		{\sc{3a}}(prevocalic)	companion \\
\glt
\exi{}
\gll	jun 	tuul 			aj 			leon=o \\
	one	{\sc{clf.anim}}	{\sc{gm.m}}	lion={\sc{ev}} \\
\glt 
\exi{}
\gll	uy				ad'-aj-\O-oo'	 			b'in 	ti	 		u	 	b’ajil \\
	{\sc{3a}}(prevocalic)	say-{\sc{tr.pfv-3b-3.pl}}	{\sc{hsy}}	{\sc{prep}}		{\sc{3a}}	self \\
\glt `One day {\bf{that which is (a) jaguar}} together with a [{\sc{num}} + {\sc{clf}}] lion,\footnote{The word {\emph{leon}} `lion, jaguar' belongs to a subset of Mopan vocabulary that is lexically specified for gender.  For such nouns a gender marker is essentially obligatory and has no relationship to definiteness (see \citealt{contini:morava:danziger:18} for more on the Mopan gender markers).} they said to each other ...'
\end{exe}
...
{\emph{Jun}} `one' + classifier\is{classifiers!numeral classifiers} with and without ART for pragmatically specific new referent.
	...
	\gll	pues	k'och-ij				tub'a		yan-\O \\
		so	arrive-{\sc{3b.intr.pfv}}	where	exist-{\sc{3b}} \\
	\glt
	\exi{}
	\gll	{\bf{jun}}	{\bf{teek}}		{\bf{a}}	{\bf{m\"ap=\"a}}. \\
		one		{\sc{clf}}.plant	{\sc{art}}		cocoyol\_palm={\sc{ev}} \\
	\glt	`So he arrived at [a place] where there was {\bf{a [{\sc{num}} + {\sc{clf}} + {\sc{art}}] cocoyol palm}}.'
	%%
	\ex\label{3ex:24b}
	...
	\gll	entonses		b'in-ij				u		ka'		k\"ax-\"a'. \\
		then			go-{\sc{3b.intr.pfv}}	{\sc{3a}}	again	seek-{\sc{3b.tr.irr}} \\
	\glt
	\exi{}	
	\gll	ke'en-{\O}			yalam	{\bf{jun}}	{\bf{teek}}		{\bf{m\"ap}}.  \\
		be.located-{\sc{3b}}	under	one		{\sc{clf}}.plant	cocoyol\_palm \\
	\glt	`So he [puma] went off to look for him [rabbit] again. He [rabbit] was located under {\bf{a [{\sc{num}} + {\sc{clf}}, no {\sc{art}}] cocoyol palm}}.'
	\end{xlista}
\end{exe}
...
\gll	tan-{\O}				b'in		u		tz\"aj-ik-{\O}		a	ja'as=a. \\
	be.continuing-{\sc{3b}}	{\sc{hsy}}	{\sc{3a}}	fry-{\sc{tr.ipfv-3b}}	{\sc{art}}	banana={\sc{ev}} \\
\glt
\exi{}
\gll	tan-{\O}				b'in		u		tz\"aj-ik-{\O}		{\bf{a}}	{\bf{kamut=u}}. \\
	be.continuing-{\sc{3b}}	{\sc{hsy}}	{\sc{3a}}	fry-{\sc{tr.ipfv-3b}}	{\sc{art}}		sweet.potato={\sc{ev}} \\
...
\gll 	entonses 	ti 			ka'		b'in 		jun 	tuul 			ilik 	b'in  \\
	then 		{\sc{prep}} 	again	{\sc{hsy}} 	one 	{\sc{clf.anim}} 	just	{\sc{hsy}} \\
\glt 
\exi{}
\gll	a 	koch		p'at-al				ti			uk'-ul \\		 
	{\sc{art}}	last.one	abandon-{\sc{intr.pfv}}	{\sc{prep}}		drink-{\sc{intr.ipfv}} \\
\glt 
\exi{}
\gll	ichil		{\bf{a}}	{\bf{tunich}}	{\bf{a}}	{\bf{b'e'=e}} \\
	inside	{\sc{art}}	rock			{\sc{art}}	{\sc{d.3\_nv=ev}} \\
\glt 
\exi{}
\gll	entonses	pues		te'=ij=i,  \\
	then		so		{\sc{loc.3.nv=scope=ev}} \\
\glt 
\exi{}
\gll	b'in-ij				b'in			u		chiit-t-ej \\
	go-{\sc{3b.intr.pfv}}	{\sc{hsy}}		{\sc{3a}}	speak.to-{\sc{t-3b.tr.irr}} \\
\glt 
\exi{}
\gll	a 	b'e'			a 	ma'ax=a. \\
	{\sc{art}} 	{\sc{d.3.nv}}	art	monkey={\sc{ev}} \\
...
\gll	pero			le'ek 			a	muyal \\
	{\sc{disc}}		3.{\sc{emph}}	{\sc{art}}	cloud \\
\glt
\exi{}
\gll	a 	tan-{\O}				u		b’eel			ti			u		wich=i. \\
	{\sc{art}}	be.continuing-{\sc{3b}}	{\sc{3a}}	go.{\sc{ipfv}}	{\sc{prep}}		{\sc{3a}}	face={\sc{ev}} \\
...
\gll	pues		jak'-s-ab'-ij \\
	then		frighten-{\sc{caus-pass-3b.intr.pfv}} \\
\glt
\exi{}
\gll 	b'in		uy(prevocalic)		ool 		u\_men	{\bf{kan}}.  \\
	{\sc{hsy}}	{\sc{3a}} 			feeling	by 		snake \\
...
\gll	sansamal	tatz'	tan-{\O}				b'in		u		b'el \\
	daily		far	be.continuing-{\sc{3b}}	{\sc{hsy}}	3{\sc{a}}	go.{\sc{ipfv}} \\
\glt
\exi{}
\gll	u		tz'on-o'			{\bf{a}}	{\bf{yuk=u}}. \\
	3{\sc{a}}	shoot-{\sc{3.btr.irr}}	{\sc{art}}	antelope={\sc{ev}} \\
\glt	`Every day he went far [into the woods] to shoot {\bf{an [{\sc{art}}] antelope}}.'
\end{exe}
...
\gll	in 		tat=a, 			u 		k'ati 		{\bf{jun}} 	{\bf{tuul}} 		{\bf{ix}} 		{\bf{ch'up=u}}.  \\
	{\sc{1a}}	father={\sc{ev}},	{\sc{3a}}	want		one		{\sc{clf.anim}}	{\sc{gm.f}}		woman={\sc{ev}} \\
...
\gll	ix			kolool,	{\bf{k'\"anb'ul}},	{\bf{kox}} \\
	{\sc{gm.f}}		partridge	pheasant		{cojolito (type of game bird)} \\
\glt
\exi{}
\gll	etel	{\bf{a}}	{\bf{kek'enche'}}	etel	{\bf{a}}	{\bf{yuk=u}} \\
	with	{\sc{art}}	wild.pig			with	{\sc{art}}	antelope={\sc{ev}} \\
\glt
\exi{}
\gll	le'ek			kuchi			in		k'ati		tz'on-oo' 			pere		ma'		yan-{\O}		kut'an.\\
	{\sc{3.emph}}	{\sc{disc}}		{\sc{1a}}	want		shoot-{\sc{3.pl}} 	but		{\sc{neg}}	exist-{\sc{3b}}	{\sc{3.quot}} \\
\glt	` ``[{\sc{gm}}] Partridge\footnote{The word {\emph{kolool}} `partridge' is a feminine noun.  Recall (supra note 19) that for this subset of nouns a gender marker is essentially obligatory.}, [no {\sc{art}}] {\bf{pheasant}}, [no {\sc{art}}] {\bf{cojolito}} [type of game bird], and [{\sc{art}}] {\bf{wild pig}}, and [{\sc{art}}] {\bf{antelope}}, those are what I really want to hunt, but they aren't there!'' he said.'
\end{exe}
...
\midrule
{\footnotesize{ART}}						& ++ & ++ & +\footnote{Most likely to occur with high discourse salience.\is{discourse salience}} & + & + \\ %\hline
{\footnotesize{Relativized deictic\is{relativized deictics} {\emph{b'e'}} }}		&++ & + & + & + & \minus \\ %\hline
{\footnotesize{Emphatic pronoun\is{emphatic pronoun} {\emph{le'ek}} }}	&++ & + & + & + & \minus \\ %\hline
{\footnotesize{NUM + CLF + ART}}				& \minus & \minus & + & \minus & \minus \\ \hline
{\footnotesize{NUM + CLF	}}				& \minus & \minus & + & + & + \\ %\hline
{\footnotesize{Bare nominal}}					& + & + & + & +	 & + \\ %\hline
\lspbottomrule
\end{tabular}
}}
