...
\gll	aggʷ{\bf{í}}d		\hspace*{1.4cm} aggʷid{\bf{á}}n \\
	man.{\sc{sg.m}}		{} man.{\sc{pl.m}} \\
\glt
\ex\label{5ex:2}
\gll	talt{\bf{í}}			\hspace*{1cm} təltaw{\bf{é}}n \\
	woman.{\sc{sg.f}}	{} woman.{\sc{pl.f}} \\
\glt
\end{exe}
...
\gll	agb{\bf{ə́}}n		\hspace*{0.95cm}	g 	{\bf{á}}gbən \\
	house.{\sc{sg.m}}	{} in 	house.{\sc{sg.m}} \\
\glt
\ex\label{5ex:4}
\gll	am{\bf{á}}n		\hspace*{1cm}	i	{\bf{á}}man \\
	water.{\sc{pl.m}}	{} to 	water.{\sc{pl.m}} \\
\glt
\ex\label{5ex:4}		
\gll	ul{\bf{í}}			\hspace*{1cm}	sg 	{\bf{ú}}li \\
	heart.{\sc{sg.m}}	{} from	heart.{\sc{sg.m}} \\
\glt
\end{exe}
...
\ex\label{5ex:6}
\gll	di			{\bf{aggʷíd}}. \\
	{\sc{exist}}		man.{\sc{sg.m}} \\
\glt	`There was a man.'
\ex\label{5ex:7}
\gll	di			{\bf{taltí}}		/	d	{\bf{aggʷíd}}. \\
	{\sc{exist}}	woman.{\sc{sg.f}}	/	and	man.{\sc{sg.m}} \\
...
\gll	šal n isíwan ɣúṛ-əs {\bf{iǧəḅḅaṛə́n}} dabb. \\
	town.{\sc{sg.m}} of siwa at-{\sc{3sg}} palm\_tree.{\sc{pl.m}} many \\
...
\gll	máṛṛa di {\bf{aggʷíd}} / d::: ɣúṛ-əs {\bf{tləččá}} / \\
	once	{\sc{exist}} man.{\sc{sg.m}} /	and at-{\sc{3sg}} girl.{\sc{sg.f}} / \\
\glt
\exi{}
\gll	d {\bf{akəḅḅí}}. / abbá-nnəs n tlə́čča / \\
	and boy.{\sc{sg.m}} / father.{\sc{sg.m-poss.3sg}} of girl.{\sc{sg.f}} / \\
...
\gll	əssn-ím-a	ánni	azídi	/ \\
	know.{\sc{pfv-2pl-pragm}}	{\sc{comp}}	jackal.{\sc{sg.m}}	/ \\
\glt
\exi{}
\gll	l-í-ʕəṃṃaṛ	ɣúṛ-əs	{\bf{ankán}}	/	{\bf{agbə́n}}	/ \\
	{\sc{neg-3sg.m}}-do.{\sc{ipfv}}	at-{\sc{3sg}}	place.{\sc{sg.m}}	/	house.{\sc{sg.m}}	/ \\
\glt
\exi{}
\gll	díma	i-ʕə́ṃṃaṛ	{\bf{taṃɣáṛt}}	/ \\
	always	{\sc{3sg.m}}-do.{\sc{ipfv}}	cave.{\sc{sg.f}}	/ \\
\glt
\exi{}
\gll	g	{\bf{idrarə́n}}.	/ \\
	in	mountain.{\sc{pl.m}}	/ \\
...
\gll	əntátət	t-iráw	{\bf{tləččá}}	/  {\bf{tləččá}}	n	tkwáyəst \\
	{\sc{idp.3sg.f}}	{\sc{3sg.f}}-give\_birth.{\sc{pfv}}	girl.{\sc{sg.f}}	/  girl.{\sc{sg.f}}	of	beautiful.{\sc{sg.f}} \\
...
\gll	kan xsi-ṭ aẓəṛṛá šal s ə́nniǧ g-úni-ṭ i {\bf{adrár}}. \\
	if want.{\sc{pfv-2sg}} see.{\sc{vn}} town.{\sc{sg.m}} from up {\sc{irr}}-climb.{\sc{aor-2sg}} to mountain.{\sc{sg.m}} \\	
\glt	`If you want to see the town from the top, you will (have) to climb a mountain.'
%%%
\ex\label{5ex:14}
\gll	yə-mráq g {\bf{ankán}} / y-ifá	aṭíl. \\
	{\sc{3sg.m}}-reach.{\sc{pfv}} in place.{\sc{sg.m}} / {\sc{3sg.m}}-find.{\sc{pfv}} garden.{\sc{sg.m}} \\
...
\gll	ga-nə́-bdu		sg	{\bf{aǧəḅḅáṛ}}. \\
	{\sc{irr-1pl}}-start.{\sc{aor}} from palm\_tree.{\sc{sg.m}} \\
...
\begin{exe}
\ex\label{5ex:16}
\gll	{\bf{təččíwen}} tə-ṛṭá-ya / \\
	girl.{\sc{pl.f}} {\sc{3sg.f}}-cover.{\sc{pfv-pragm}} /  \\
\glt
\exi{}
\gll	{\bf{təltáwen}} tə-ṛṭá-ya. / \\
	woman.{\sc{pl.f}} {\sc{3sg.f}}-cover.{\sc{pfv-pragm}} / \\
...
\gll	baʕdén	yə-ʕṃṛ-ín-a	/	albáb	/ \\
	then	3-do.{\sc{pfv-pl-pragm}}	/	door.{\sc{sg.m}}	/ \\
\glt
\exi{}
\gll	i-təṃṃá-n-as	albáb	n	šal.	/ \\
	3-say.{\sc{ipfv-pl-3sg.dat}}	door.{\sc{sg.m}}	of	town.{\sc{sg.m}}	/ \\
\glt
\exi{}
\gll	{\bf{ləmšáyəx}}	yə-ʕʕə́nʕən-ən	ə́gd-əs.	/	\\
	chief.{\sc{pl.m}}	3-sit\_down.{\sc{pfv-pl}}	in-{\sc{3sg}}	/	\\
...
\gll	kan	{\bf{əṭṭáḅənt}}	tə-ḥmá-ya \\
	if	oven.{\sc{sg.f}}	{\sc{3sg.f}}-be\_hot.{\sc{pfv-pragm}} \\
...
\gll	baʕdén tə-ẓṛ-á sg {\bf{állon}}. \\
	then 3{\sc{sg.f}}-see.{\sc{pfv-3sg.m.do}} from window.{\sc{sg.m}} \\
...
\gll	t-uṭá	i	{\bf{ánu}}	n	áman. \\
	3{\sc{sg.f}}-fall.{\sc{pfv}}	to	well.{\sc{sg.m}}	of	water.{\sc{pl.m}} \\
...
\gll	t-ṛaḥ	tə-ṣṣáy	{\bf{əṭṭánǧṛət}}	/ \\
	{\sc{3sg.f}}-go.{\sc{pfv}}	{\sc{3sg.f}}-take.{\sc{pfv}}	pot.{\sc{sg.f}}	/ \\
\glt
\exi{}
\gll	tə-ɣṛə́ṣ	tyaẓə́ṭ.	/ \\
	{\sc{3sg.f}}-slaughter.{\sc{pfv}}	chicken.{\sc{sg.f}}	/ \\
...
\ex\label{5ex:22}
\gll	{\bf{agbə́n}}-nək \\
	house.{\sc{sg.m-poss.2sg.m}} \\
\glt	`your house'
\ex\label{5ex:23}
\gll	{\bf{abbá}}-nnəs \\
	father.{\sc{sg.m-poss.3sg}} \\
\glt	`his father'
\end{exe}
...
\begin{exe}
\ex\label{5ex:25}
\gll	{\bf{tḥəbbə́t}}	n	{\bf{təṃẓén}} \\
	grain.{\sc{sg.f}}	of	barley.{\sc{pl.f}} \\
...
\gll	t-qad		{\bf{tləččá}}	{\bf{tat-ók}}	/ \\
	{\sc{3sg.m}}-take.{\sc{pfv}}	girl.{\sc{sg.f}}	{\sc{dem.f-2sg.m}}	/ \\
\glt 
\exi{}
\gll	tə-mráq	g	təṭ. \\
	{\sc{3sg.f}}-reach.{\sc{pfv}}	in	spring.{\sc{sg.f}} \\
\glt	`She took this girl, she arrived at the spring.'
\end{exe}

Cases where nouns followed by demonstratives\is{demonstratives} have the accent on the penultimate syllable are nevertheless attested, especially (but not exclusively) when they appear in left-detached constructions:\footnote{This construction will be discussed in detail in Section \ref{5sec:25}.}

\begin{exe}
\ex\label{5ex:27}
\gll	i-ʕəṃṃáṛ-ən	naknáf.	/ \\
	3-do.{\sc{ipfv-pl}}	naknaf.{\sc{sg.m}}	/ \\
\glt
\exi{}
\gll	{\bf{náknaf}}	{\bf{daw-érwən}}	/	smiyət-ə́nnəs	/ \\
	naknaf.{\sc{sg.m}}	{\sc{dem-2pl}}	/	name.{\sc{sg.f-poss.3sg}}	/ \\
...
\gll	sg	{\bf{ə́lwoqt}}	tat-érwən \\
	from	time.{\sc{sg.f}}	{\sc{dem.f-2pl}} \\
\glt	`from that moment'
\ex\label{5ex:29}
\gll	ánni	gá-ḥḥ-ax	d	{\bf{iṣəṛɣénən}}	daw-i-(y)óm. \\
	{\sc{comp}}	{\sc{irr}}-go.{\sc{aor-1sg}}	and	bedouin.{\sc{pl.m}}	{\sc{dem-pl-2sg.f}} \\
...
\gll	i-lə́hhu-n	/	{\bf{təṛwawén}} \\
	3-be\_happy.{\sc{ipfv-pl}}	/	child.{\sc{pl.f}} \\
...
\gll	əǧǧə́n	n	áddoṛ	/	y-uṭə́n	/	{\bf{Ḥássnin}}.	/ \\
	one.{\sc{m}}	of	time.{\sc{sg.m}}	/	{\sc{3sg.m}}-get\_sick.{\sc{pfv}}	/	ḥassnin	/ \\
\glt
\exi{}
\gll	yə-ngə́r	yə-ṭṭís-a	g	ágbən.	// \\
	{\sc{3sg.m}}-stay.{\sc{pfv}}	{\sc{3sg.m}}-rest.{\sc{pfv-pragm}}	in	house.{\sc{sg.m}}	// \\
...
\gll	g-úɣi-x	ə́ǧǧət	gə́d-sən	/ \\
	{\sc{irr}}-buy.{\sc{aor-1sg}}	one.{\sc{f}}	from-{\sc{3pl}}	/ \\
\glt
\exi{}
\gll	{\bf{amẓá}}	{\bf{daw-óm}}. \\
	ogre.{\sc{sg.m}}	{\sc{dem-2sg.f}} \\
\glt `He thought: ``I will marry one of them'', this ogre.'
\end{exe}

Contrary to descriptive relative clauses where the relative marker is not obligatory, restrictive relative clauses are introduced by {\emph{(n) wən}} (`{\sc{sg.m/pl}}' and sometimes `{\sc{sg.f}}') or {\emph{tən}} (`{\sc{sg.f}}') \citep{schiattarella:14}. Head nouns in these kinds of relative clauses must usually be considered definite and have the accent on the penultimate syllable:

\begin{exe}
\ex\label{5ex:33}
\gll	{\bf{tálti}}	wәn	aggʷid-ə́nnәs	yә-ṃṃút \\
	woman.{\sc{sg.f}}	{\sc{rel}}	 man.{\sc{sg.m-poss.3sg}} 	{\sc{3sg.m}}-die.{\sc{pfv}} \\
...
\gll	yə-ṭlə́b	s	ɣúṛ-əs	{\bf{tləččá}} \\
	{\sc{3sg.m}}-ask.{\sc{pfv}}	from	at-{\sc{3sg}}	girl.{\sc{sg.f}} \\
\glt
\exi{}
\gll	n	wən	yə-xs-ét. \\
	of	{\sc{rel}}	{\sc{3sg.m}}-want.{\sc{pfv-3sg.f.do}} \\
...
\gll	kull	{\bf{ə́ǧǧən}}	wən	ɣúṛ-əs	aṭíl \\
	every	one.{\sc{m}}	{\sc{rel}}	at-{\sc{3sg}}	garden.{\sc{sg.m}} \\
...
\gll	mak	{\bf{ə́ǧǧən}}	yə-xsá	anǧáf \\
	when	one.{\sc{m}}	{\sc{3sg.m}}-want.{\sc{pfv}}	marry.{\sc{vn}} \\
...
\gll	gá-ḥḥ-aṭ	{\bf{ankán}}	n	áʕṛus. \\
	{\sc{irr}}-go.{\sc{aor-2sg}}	place.{\sc{sg.m}}	of	wedding.{\sc{sg.m}} \\
\glt	`You will go to the wedding place.' 
\ex\label{5ex:38}
\gll	yə-ččá	{\bf{əlgaṛá}}. \\
	{\sc{3sg.m}}-eat.{\sc{pfv}}	el\_gara \\
\glt	`He ate in El Gara.'
\ex\label{5ex:39}
\gll	ənnə́gr-ax		{\bf{šalí}}. \\
	live.{\sc{ipfv-1sg}}	shali \\
\glt	`I live in Shali.'
\end{exe}
...
\gll	*i-nə́ddum		timədrást. \\
	{\sc{3sg.m}}-sleep.{\sc{ipfv}}	school.{\sc{sg.f}} \\
...
\gll	i-təčč	aksúm	{\bf{timədrast-ənnə́s}}. \\
	{\sc{3sg.m}}-eat.{\sc{ipfv}}	meat.{\sc{sg.m}}	school.{\sc{sg.f-poss.3sg}} \\
...
\gll	di	{\bf{tləččá}}	tkwayə́st	t-ṛáwad-as \\
	{\sc{exist}}	girl.{\sc{sg.f}}	beautiful.{\sc{sg.f}}	{\sc{3sg.f}}-look.{\sc{ipfv-3sg.dat}} \\
\glt
\exi{}
\gll	sg	állon.	 //	{\bf{tlə́čča}}	t-nə́ddum. \\
	from	window.{\sc{sg.m}}	//	girl.{\sc{sg.f}}	{\sc{3sg.f}}-sleep.{\sc{ipfv}} \\
...
\gll 	g-í-ftək	{\bf{talís}} \\
	{\sc{irr-3sg.m}}-open.{\sc{aor}}	tank.{\sc{sg.f}} \\
\glt
\exi{}
\gll	g-i-sə́-ssu	amán.	/ \\
	{\sc{irr-3sg.m-caus}}-drink.{\sc{aor}}	water.{\sc{pl.m}}	/ \\
\glt
\exi{}
\gll	kan	lá-di	{\bf{tális}} \\
	if	{\sc{neg-exist}}	tank.{\sc{sg.f}} \\
\glt	`He opens a tank and he drinks water. If there is no tank...'
%%
\ex\label{5ex:45}
\gll	máṛṛa	di	{\bf{azidí}}	/	d	tɣátt	// \\
	time	{\sc{exist}}  jackal.{\sc{sg.m}}	/	and	goat.{\sc{sg.f}}	// \\
\glt
\exi{}
\gll	{\bf{azídi}}	kull	yom	/	g-í-f̣f̣aɣ.	/ \\
	jackal.{\sc{sg.m}}	every	day	/	{\sc{irr-3sg.m}}-go\_out.{\sc{aor}}	/ \\
...
\gll	əlmanẓár	{\bf{aməllál}}	/	{\bf{amə́llal}}	dáw-om	/	w-om	{\bf{tisə́nt}}.	/ \\
	view.{\sc{sg.m}}		white.{\sc{sg.m}}	/	white.{\sc{sg.m}}	{\sc{dem-2sg.f}}	/  {\sc{dem-2sg.f}}	salt.{\sc{sg.f}}	/\\
\glt
%%
\exi{}
\gll	{\bf{tísənt}}	/	ənšní	n-xə́ddam-et. \\
	salt.{\sc{sg.f}}	/	{\sc{idp.1pl}}	{\sc{1pl}}-work.{\sc{ipfv-3sg.f.do}} \\
\glt	`A white view, this white, it is the salt. The salt, we work it.'
%%
\ex\label{5ex:47}
\gll	sad\_əlḥának	s	{\bf{tiní}}	/	d	{\bf{arə́n}}	/ \\
	sad\_əlḥanak	with	date.{\sc{sg.f}}	/	and	flour.{\sc{pl.m}}	/ \\
\glt
\exi{}
\gll	bass	{\bf{tíni}}	d	{\bf{árən}}	/ \\
	but	date.{\sc{sg.f}}	and	flour.{\sc{pl.m}}	/ \\
\glt
\exi{}
\gll	l-í-ḥaṭṭu-n-{\bf{asən}}	amán.\\
	{\sc{neg}}-3-put.{\sc{ipfv-pl-3pl.dat}}	water.{\sc{pl.m}} \\
